...
namespace mhedit.Containers
{
    ...
    public abstract class ChangeTrackingBase : NotifyPropertyChangedBase, IChangeTracking
    {
        ...
        /// <summary>
        /// Use this method to forward the IsChanged PropertyChanged event from composite
        /// members of a class. This handler specifically avoids setting the local IsChanged
