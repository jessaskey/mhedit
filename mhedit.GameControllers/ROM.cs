        ...
        private int BaseAddressForPage(ushort address, int offset, int page)
        {
            ...
            switch(page)
            {
                ...
                case 7:
                    ...
                    break;
                default:
                    throw new ArgumentOutOfRangeException($"Invalid page {page}, expected 6 or 7");
            };
    ...
    public class ExportsFile
    {
        ...
        public ExportsFile(string filePath)
        {
            ...
            if ((File.GetAttributes(filePath) & FileAttributes.Directory) ==
                 FileAttributes.Directory)
            {
                this._filePath = Directory.GetFiles(filePath, $"*.{FileExtension}", SearchOption.TopDirectoryOnly).FirstOrDefault();
            }
        }
