    ...
    public class MazeWall : MazeObject
    {
        ...
        private void LoadDefaultImage()
        {
            if (_dynamicWall)
            {
                ...
                {
                    case MazeWallType.Empty:
                        _img = Resource.GetResourceImage("images.objects.wallc_empty_64.ico");
                        break;
                    case MazeWallType.Horizontal:
                        _img = Resource.GetResourceImage("images.objects.wallc_horizontal_64.ico");
                        break;
                    case MazeWallType.LeftDown:
                        _img = Resource.GetResourceImage("images.objects.wallc_leftdown_64.ico");
                        break;
                    case MazeWallType.LeftUp:
                        _img = Resource.GetResourceImage("images.objects.wallc_leftup_64.ico");
                        break;
                    case MazeWallType.RightDown:
                        _img = Resource.GetResourceImage("images.objects.wallc_rightdown_64.ico");
                        break;
                    case MazeWallType.RightUp:
                        _img = Resource.GetResourceImage("images.objects.wallc_rightup_64.ico");
                        break;
                    case MazeWallType.Vertical:
                        _img = Resource.GetResourceImage("images.objects.wallc_vertical_64.ico");
                        break;
                    default:
                        //just in case
                        _img = Resource.GetResourceImage("images.objects.wallc_empty_64.ico");
            ...
            else
            {
                ...
                {
                    case MazeWallType.Empty:
                        _img = Resource.GetResourceImage("images.objects.wall_empty_64.ico");
                        break;
                    case MazeWallType.Horizontal:
                        _img = Resource.GetResourceImage("images.objects.wall_horizontal_64.ico");
                        break;
                    case MazeWallType.LeftDown:
                        _img = Resource.GetResourceImage("images.objects.wall_leftdown_64.ico");
                        break;
                    case MazeWallType.LeftUp:
                        _img = Resource.GetResourceImage("images.objects.wall_leftup_64.ico");
                        break;
                    case MazeWallType.RightDown:
                        _img = Resource.GetResourceImage("images.objects.wall_rightdown_64.ico");
                        break;
                    case MazeWallType.RightUp:
                        _img = Resource.GetResourceImage("images.objects.wall_rightup_64.ico");
                        break;
                    case MazeWallType.Vertical:
                        _img = Resource.GetResourceImage("images.objects.wall_vertical_64.ico");
                        break;
                }
            }
        }
        ...
        public override Image Image 
        {
            get
            {
                ...
                if (_userWall)
                {
                    _img = Resource.ReplaceColor(_img, Color.Green, Color.Blue);
                }
